...
export interface ApiBusinessBusiness extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sources: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['cuisine', 'dish', 'style', 'vehicleType', 'other']
    > &
      Schema.Attribute.DefaultTo<'cuisine'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCustomPageCustomPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroBlurb: Schema.Attribute.Text;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    autoImported: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    ingredientsAllergens: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    > &
      Schema.Attribute.Private;
    overrideLock: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    price: Schema.Attribute.Decimal;
    primaryCategory: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    ...
    >;
    slug: Schema.Attribute.UID<'title'>;
    sourceSnapshot: Schema.Attribute.JSON;
...
export interface ApiSourceWebsiteSourceWebsite
  extends Struct.CollectionTypeSchema {
  collectionName: 'source_websites';
  info: {
    displayName: 'SourceWebsite';
    pluralName: 'source-websites';
    singularName: 'source-website';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entryPaths: Schema.Attribute.JSON;
    headers: Schema.Attribute.JSON;
    ingestStatus: Schema.Attribute.Enumeration<['active', 'paused', 'error']> &
    ...
    mode: Schema.Attribute.Enumeration<
      ['auto_schema', 'auto_heuristic', 'rules_css']
    > &
      Schema.Attribute.DefaultTo<'auto_schema'>;
    publishedAt: Schema.Attribute.DateTime;
    respectRobotsTxt: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    revisitIntervalMinutes: Schema.Attribute.Integer &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::source-website.source-website': ApiSourceWebsiteSourceWebsite;
